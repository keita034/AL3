...
Vector3 WorldTransform::VecMatMul(Vector3& vec)
{
	Vector3 retVec;

	retVec.x = vec.x * matWorld_.m[0][0] + vec.y * matWorld_.m[1][0] + vec.z * matWorld_.m[2][0];

	retVec.y = vec.x * matWorld_.m[0][1] + vec.y * matWorld_.m[1][1] + vec.z * matWorld_.m[2][1];

	retVec.z = vec.x * matWorld_.m[0][2] + vec.y * matWorld_.m[1][2] + vec.z * matWorld_.m[2][2];
